...
xor.2233:
	addi %a2 %zero 0 #101
	bne %a0 0 beq_else.8439
	addi %a0 %a1 0 #101
	jalr %zero %ra 0 #101
beq_else.8439:
	bne %a1 0 beq_else.8440
	addi %a0 %zero 1 #101
	jalr %zero %ra 0 #101
beq_else.8440:
	addi %a0 %a2 0 #101
...
beq_else.8441:
	...
	jalr %zero %ra 0 #107
fneg_cond.2238:
	bne %a0 0 beq_else.8443
	jal	%zero min_caml_fneg
beq_else.8443:
	jalr %zero %ra 0 #555
add_mod5.2241:
	add %a0 %a0 %a1 #119
	blt %a0 5 bge_else.8444
	addi %a0 %a0 -5 #120
	jalr %zero %ra 0 #120
bge_else.8444:
	jalr %zero %ra 0 #120
...
vecunit_sgn.2262:
	...
	addi %sp %sp -40 #169
	lw %ra %sp 36 #169
	bne %a0 0 beq_else.8450 # nontail if
	lw %a0 %sp 0 #169
	bne %a0 0 beq_else.8452 # nontail if
	li %a0 l.5555 #169
	slli %a0 %a0 2 #169
	lw %f0 %a0 0 #169
	lw %f1 %sp 24 #169
	fdiv %f0 %f0 %f1 #169
	jal %zero beq_cont.8453 # then sentence ends
beq_else.8452:
	li %a0 l.5557 #169
	slli %a0 %a0 2 #169
	lw %f0 %a0 0 #169
	...
	fdiv %f0 %f0 %f1 #169
beq_cont.8453:
	jal %zero beq_cont.8451 # then sentence ends
beq_else.8450:
	li %a0 l.5555 #169
	slli %a0 %a0 2 #169
	lw %f0 %a0 0 #169
...
beq_else.8465:
	...
	lw %ra %sp 44 #667
	lw %a1 %sp 20 #640
	bne %a1 0 beq_else.8466 # nontail if
	jal %zero beq_cont.8467 # then sentence ends
beq_else.8466:
	sw %a0 %sp 44 #670
...
beq_cont.8467:
	lw %a1 %sp 12 #640
	bne %a1 2 beq_else.8468 # nontail if
	addi %a2 %zero 1 #679
...
beq_cont.8469:
	...
	add %a14 %a6 %a5 #691
	sw %a1 %a14 0 #691
	bne %a4 3 beq_else.8470 # nontail if
	lw %f0 %a2 0 #646
	sw %f0 %sp 56 #697
	...
	addi %sp %sp -72 #697
	lw %ra %sp 68 #697
	bne %a0 0 beq_else.8473 # nontail if
	lw %f0 %sp 56 #697
	sw %ra %sp 68 #697 call dir
	addi %sp %sp 72 #697
	jal %ra sgn.2236 #697
	...
	lw %f1 %sp 64 #697
	fdiv %f0 %f1 %f0 #697
	jal %zero beq_cont.8474 # then sentence ends
beq_else.8473:
	li %a0 l.5553 #697
	slli %a0 %a0 2 #697
	lw %f0 %a0 0 #697
beq_cont.8474:
	...
	addi %sp %sp -88 #699
	lw %ra %sp 84 #699
	bne %a0 0 beq_else.8475 # nontail if
	lw %f0 %sp 72 #699
	sw %ra %sp 84 #699 call dir
	addi %sp %sp 88 #699
	jal %ra sgn.2236 #699
...
beq_cont.8476:
	...
	addi %sp %sp -104 #701
	lw %ra %sp 100 #701
	bne %a0 0 beq_else.8477 # nontail if
	lw %f0 %sp 88 #701
	sw %ra %sp 100 #701 call dir
	addi %sp %sp 104 #701
	jal %ra sgn.2236 #701
...
beq_cont.8478:
	lw %a0 %sp 24 #701
	sw %f0 %a0 8 #701
	jal %zero beq_cont.8471 # then sentence ends
beq_else.8470:
	bne %a4 2 beq_else.8479 # nontail if
	addi %a1 %zero 0 #705
	lw %a4 %sp 32 #679
	bne %a4 0 beq_else.8481 # nontail if
	addi %a1 %zero 1 #705
...
beq_cont.8471:
	lw %a0 %sp 20 #640
	bne %a0 0 beq_else.8483 # nontail if
...
solver_second.2418:
	...
	addi %sp %sp -80 #864
	lw %ra %sp 76 #864
	bne %a0 3 beq_else.8512 # nontail if
	li %a0 l.5555 #864
	slli %a0 %a0 2 #864
	lw %f0 %a0 0 #864
	lw %f1 %sp 64 #864
	fsub %f0 %f1 %f0 #864
	jal %zero beq_cont.8513 # then sentence ends
beq_else.8512:
	lw %f0 %sp 64 #818
beq_cont.8513:
	lw %f1 %sp 56 #866
...
beq_else.8514:
	...
	addi %sp %sp -104 #870
	lw %ra %sp 100 #870
	bne %a0 0 beq_else.8515 # nontail if
	lw %f0 %sp 88 #870
	sw %ra %sp 100 #870 call dir
	addi %sp %sp 104 #870
...
solver_rect_fast.2428:
	...
	lw %ra %sp 68 #899
	addi %a1 %zero 0 #899
	bne %a0 0 beq_else.8521 # nontail if
	addi %a0 %a1 0 #899
...
beq_else.8521:
	...
	addi %sp %sp -88 #900
	lw %ra %sp 84 #900
	bne %a0 0 beq_else.8524 # nontail if
	lw %a0 %sp 64 #899
...
beq_else.8524:
	...
	addi %sp %sp -88 #901
	lw %ra %sp 84 #901
	bne %a0 0 beq_else.8526 # nontail if
	addi %a0 %zero 1 #901
...
beq_cont.8522:
	...
	addi %sp %sp -112 #908
	lw %ra %sp 108 #908
	bne %a0 0 beq_else.8530 # nontail if
	lw %a0 %sp 88 #898
...
beq_else.8530:
	...
	addi %sp %sp -120 #909
	lw %ra %sp 116 #909
	bne %a0 0 beq_else.8532 # nontail if
	lw %a0 %sp 88 #898
...
beq_else.8532:
	...
	addi %sp %sp -120 #910
	lw %ra %sp 116 #910
	bne %a0 0 beq_else.8534 # nontail if
	addi %a0 %zero 1 #910
...
beq_cont.8531:
	...
	addi %sp %sp -136 #917
	lw %ra %sp 132 #917
	bne %a0 0 beq_else.8537 # nontail if
	lw %a0 %sp 88 #898
...
beq_else.8537:
	...
	addi %sp %sp -144 #918
	lw %ra %sp 140 #918
	bne %a0 0 beq_else.8539 # nontail if
	lw %a0 %sp 88 #898
...
beq_else.8539:
	...
	addi %sp %sp -144 #919
	lw %ra %sp 140 #919
	bne %a0 0 beq_else.8541 # nontail if
	addi %a0 %zero 1 #919
...
solver_second_fast.2441:
	...
	addi %sp %sp -80 #946
	lw %ra %sp 76 #946
	bne %a0 3 beq_else.8549 # nontail if
	li %a0 l.5555 #946
	slli %a0 %a0 2 #946
	lw %f0 %a0 0 #946
	lw %f1 %sp 64 #946
...
beq_else.8551:
	...
	addi %sp %sp -96 #949
	lw %ra %sp 92 #949
	bne %a0 0 beq_else.8552 # nontail if
	lw %f0 %sp 80 #952
	...
	lw %a0 %sp 0 #952
	sw %f0 %a0 0 #952
	jal %zero beq_cont.8553 # then sentence ends
beq_else.8552:
	lw %f0 %sp 80 #950
...
beq_else.8562:
	...
	addi %sp %sp -96 #996
	lw %ra %sp 92 #996
	bne %a0 0 beq_else.8563 # nontail if
	lw %f0 %sp 80 #999
	...
	lw %a0 %sp 0 #999
	sw %f0 %a0 0 #999
	jal %zero beq_cont.8564 # then sentence ends
beq_else.8563:
	lw %f0 %sp 80 #997
...
solver_fast2.2465:
	...
	lw %a13 %sp 8 #1015
	lw %a12 %a13 0 #1015
	jalr %zero %a12 0 #1015
beq_else.8566:
	bne %a0 2 beq_else.8567
	lw %f0 %sp 48 #1017
	lw %f1 %sp 40 #1017
	lw %f2 %sp 32 #1017
	lw %a0 %sp 12 #1017
...
setup_rect_table.2468:
	...
	addi %sp %sp -16 #1028
	lw %ra %sp 12 #1028
	bne %a0 0 beq_else.8568 # nontail if
	lw %a0 %sp 0 #1032
	...
	fdiv %f0 %f0 %f1 #1034
	sw %f0 %a0 4 #1034
	jal %zero beq_cont.8569 # then sentence ends
beq_else.8568:
	li %a0 l.5553 #1029
	slli %a0 %a0 2 #1029
	lw %f0 %a0 0 #1029
...
beq_cont.8569:
	...
	addi %sp %sp -24 #1036
	lw %ra %sp 20 #1036
	bne %a0 0 beq_else.8570 # nontail if
	lw %a0 %sp 0 #1039
...
beq_cont.8571:
	...
	addi %sp %sp -32 #1042
	lw %ra %sp 28 #1042
	bne %a0 0 beq_else.8572 # nontail if
	lw %a0 %sp 0 #1045
...
setup_surface_table.2471:
	...
	addi %sp %sp -72 #1057
	lw %ra %sp 68 #1057
	bne %a0 0 beq_else.8575 # nontail if
	li %a0 l.5553 #1065
	slli %a0 %a0 2 #1065
	lw %f0 %a0 0 #1065
	lw %a0 %sp 8 #1065
	sw %f0 %a0 0 #1065
	jal %zero beq_cont.8576 # then sentence ends
beq_else.8575:
	li %a0 l.5557 #1059
	slli %a0 %a0 2 #1059
	lw %f0 %a0 0 #1059
...
setup_second_table.2474:
	...
	addi %sp %sp -80 #1082
	lw %ra %sp 76 #1082
	bne %a0 0 beq_else.8578 # nontail if
	lw %a0 %sp 8 #1087
	lw %f0 %sp 32 #1087
	sw %f0 %a0 4 #1087
	lw %f0 %sp 48 #1088
...
beq_cont.8579:
	...
	addi %sp %sp -152 #1091
	lw %ra %sp 148 #1091
	bne %a0 0 beq_else.8580 # nontail if
	li %a0 l.5555 #1092
	slli %a0 %a0 2 #1092
	lw %f0 %a0 0 #1092
	lw %f1 %sp 16 #1092
...
iter_setup_dirvec_constants.2477:
	...
	addi %sp %sp -32 #1104
	lw %ra %sp 28 #1104
	bne %a0 1 beq_else.8583 # nontail if
	lw %a0 %sp 20 #1106
	lw %a1 %sp 8 #1106
	...
	add %a14 %a3 %a2 #1106
	sw %a0 %a14 0 #1106
	jal %zero beq_cont.8584 # then sentence ends
beq_else.8583:
	bne %a0 2 beq_else.8585 # nontail if
	lw %a0 %sp 20 #1108
	lw %a1 %sp 8 #1108
...
setup_dirvec_constants.2480:
	...
	addi %a1 %a1 -1 #1117
	lw %a12 %a13 0 #1117
	jalr %zero %a12 0 #1117
setup_startp_constants.2482:
	lw %a2 %a13 4 #1122
	blt %a1 0 bge_else.8588
	slli %a3 %a1 2 #19
	add %a14 %a2 %a3 #19
	lw %a2 %a14 0 #19
	sw %a13 %sp 0 #1125
	...
	sw %f0 %a0 8 #1129
	lw %a1 %sp 20 #864
	bne %a1 2 beq_else.8589 # nontail if
	lw %a1 %sp 12 #1132
	add %a0 %a1 %zero
...
beq_else.8589:
	blt 2 %a1 bge_else.8591 # nontail if
	jal %zero bge_cont.8592 # then sentence ends
bge_else.8591:
	lw %f0 %a0 0 #18
	lw %f1 %a0 4 #18
	lw %f2 %a0 8 #18
	...
	lw %ra %sp 52 #1134
	lw %a0 %sp 20 #864
	bne %a0 3 beq_else.8593 # nontail if
	li %a0 l.5555 #1135
	slli %a0 %a0 2 #1135
	lw %f1 %a0 0 #1135
	fsub %f0 %f0 %f1 #1135
...
is_rect_outside.2487:
	...
	lw %ra %sp 36 #1153
	addi %a1 %zero 0 #1153
	bne %a0 0 beq_else.8597 # nontail if
	addi %a0 %a1 0 #1153
	jal %zero beq_cont.8598 # then sentence ends
beq_else.8597:
	lw %f0 %sp 8 #1154
	sw %a1 %sp 32 #1154
	...
	addi %sp %sp -56 #1154
	lw %ra %sp 52 #1154
	bne %a0 0 beq_else.8600 # nontail if
	lw %a0 %sp 32 #1153
...
is_second_outside.2497:
	...
	addi %sp %sp -24 #1170
	lw %ra %sp 20 #1170
	bne %a0 3 beq_else.8607 # nontail if
	li %a0 l.5555 #1170
	slli %a0 %a0 2 #1170
	lw %f0 %a0 0 #1170
	lw %f1 %sp 8 #1170
...
beq_else.8615:
	...
	addi %a1 %zero 0 #1214
	sw %f0 %sp 40 #905
	bne %a0 0 beq_else.8617 # nontail if
	addi %a0 %a1 0 #1214
...
beq_else.8619:
	...
	addi %sp %sp -56 #1221
	lw %ra %sp 52 #1221
	bne %a0 0 beq_else.8621
	lw %a0 %sp 20 #1224
	addi %a0 %a0 1 #1224
	lw %a1 %sp 12 #1224
	lw %a13 %sp 16 #1224
	lw %a12 %a13 0 #1224
	jalr %zero %a12 0 #1224
beq_else.8621:
	addi %a0 %zero 1 #1222
	jalr %zero %ra 0 #1222
...
beq_else.8622:
	...
	addi %sp %sp -16 #1243
	lw %ra %sp 12 #1243
	bne %a0 0 beq_else.8623
	lw %a0 %sp 8 #1247
	addi %a0 %a0 1 #1247
	lw %a1 %sp 0 #1247
	lw %a13 %sp 4 #1247
	lw %a12 %a13 0 #1247
	jalr %zero %a12 0 #1247
beq_else.8623:
	addi %a0 %zero 1 #1245
	jalr %zero %ra 0 #1245
...
beq_else.8624:
	...
	sw %a13 %sp 12 #1255
	sw %a0 %sp 16 #1255
	bne %a8 99 beq_else.8625 # nontail if
	addi %a0 %zero 1 #1260
...
beq_else.8625:
	...
	lw %ra %sp 28 #1262
	addi %a1 %zero 0 #1265
	bne %a0 0 beq_else.8627 # nontail if
	addi %a0 %a1 0 #1265
...
beq_else.8627:
	...
	addi %sp %sp -32 #1266
	lw %ra %sp 28 #1266
	bne %a0 0 beq_else.8629 # nontail if
	lw %a0 %sp 24 #1265
...
beq_else.8629:
	...
	addi %sp %sp -32 #1267
	lw %ra %sp 28 #1267
	bne %a0 0 beq_else.8631 # nontail if
	lw %a0 %sp 24 #1265
	jal %zero beq_cont.8632 # then sentence ends
beq_else.8631:
	addi %a0 %zero 1 #1268
beq_cont.8632:
beq_cont.8630:
beq_cont.8628:
beq_cont.8626:
	bne %a0 0 beq_else.8633
	lw %a0 %sp 16 #1278
	addi %a0 %a0 1 #1278
	lw %a1 %sp 8 #1278
	lw %a13 %sp 12 #1278
	lw %a12 %a13 0 #1278
	jalr %zero %a12 0 #1278
beq_else.8633:
	addi %a0 %zero 1 #1273
	lw %a1 %sp 0 #1273
	lw %a13 %sp 4 #1273
	...
	addi %sp %sp -32 #1273
	lw %ra %sp 28 #1273
	bne %a0 0 beq_else.8634
	lw %a0 %sp 16 #1276
	addi %a0 %a0 1 #1276
	lw %a1 %sp 8 #1276
	lw %a13 %sp 12 #1276
	lw %a12 %a13 0 #1276
	jalr %zero %a12 0 #1276
beq_else.8634:
	addi %a0 %zero 1 #1274
	jalr %zero %ra 0 #1274
...
beq_else.8637:
	...
	addi %sp %sp -80 #1297
	lw %ra %sp 76 #1297
	bne %a0 0 beq_else.8641 # nontail if
...
beq_else.8641:
	...
	addi %sp %sp -80 #1298
	lw %ra %sp 76 #1298
	bne %a0 0 beq_else.8643 # nontail if
	jal %zero beq_cont.8644 # then sentence ends
beq_else.8643:
	li %a0 l.5935 #1300
	slli %a0 %a0 2 #1300
	lw %f0 %a0 0 #1300
	...
	addi %sp %sp -112 #1304
	lw %ra %sp 108 #1304
	bne %a0 0 beq_else.8645 # nontail if
...
beq_else.8649:
	...
	sw %a13 %sp 8 #1339
	sw %a0 %sp 12 #1339
	bne %a9 99 beq_else.8651 # nontail if
	addi %a3 %zero 1 #1343
	add %a1 %a8 %zero
	add %a0 %a3 %zero
	add %a13 %a7 %zero
...
beq_else.8651:
	...
	addi %sp %sp -40 #1347
	lw %ra %sp 36 #1347
	bne %a0 0 beq_else.8653 # nontail if
...
beq_else.8653:
	...
	addi %sp %sp -40 #1350
	lw %ra %sp 36 #1350
	bne %a0 0 beq_else.8655 # nontail if
...
beq_else.8661:
	...
	addi %sp %sp -88 #1388
	lw %ra %sp 84 #1388
	bne %a0 0 beq_else.8665 # nontail if
...
beq_else.8665:
	...
	addi %sp %sp -88 #1389
	lw %ra %sp 84 #1389
	bne %a0 0 beq_else.8667 # nontail if
	jal %zero beq_cont.8668 # then sentence ends
beq_else.8667:
	li %a0 l.5935 #1391
	slli %a0 %a0 2 #1391
	lw %f0 %a0 0 #1391
	...
	addi %sp %sp -120 #1395
	lw %ra %sp 116 #1395
	bne %a0 0 beq_else.8669 # nontail if
...
beq_else.8673:
	...
	sw %a13 %sp 8 #1430
	sw %a0 %sp 12 #1430
	bne %a8 99 beq_else.8675 # nontail if
	addi %a3 %zero 1 #1434
	add %a1 %a7 %zero
	add %a0 %a3 %zero
	add %a13 %a6 %zero
...
beq_else.8675:
	...
	addi %sp %sp -40 #1438
	lw %ra %sp 36 #1438
	bne %a0 0 beq_else.8677 # nontail if
...
beq_else.8677:
	...
	addi %sp %sp -40 #1441
	lw %ra %sp 36 #1441
	bne %a0 0 beq_else.8679 # nontail if
...
get_nvector_second.2554:
	...
	addi %sp %sp -96 #1495
	lw %ra %sp 92 #1495
	bne %a0 0 beq_else.8686 # nontail if
	lw %a0 %sp 0 #1496
	lw %f0 %sp 64 #1496
	sw %f0 %a0 0 #1496
	lw %f0 %sp 72 #1497
...
get_nvector.2556:
	...
	addi %sp %sp -24 #1509
	lw %ra %sp 20 #1509
	bne %a0 1 beq_else.8688
	lw %a0 %sp 12 #1511
	lw %a13 %sp 16 #1511
	lw %a12 %a13 0 #1511
	jalr %zero %a12 0 #1511
beq_else.8688:
	bne %a0 2 beq_else.8689
	lw %a0 %sp 4 #1513
	lw %a13 %sp 8 #1513
	lw %a12 %a13 0 #1513
	jalr %zero %a12 0 #1513
beq_else.8689:
	lw %a0 %sp 4 #1515
	lw %a13 %sp 0 #1515
	lw %a12 %a13 0 #1515
	jalr %zero %a12 0 #1515
utexture.2559:
	lw %a2 %a13 4 #1522
	sw %a1 %sp 0 #1523
	sw %a2 %sp 4 #1523
	...
	lw %ra %sp 60 #1539
	lw %a1 %sp 32 #784
	bne %a1 0 beq_else.8692 # nontail if
	bne %a0 0 beq_else.8694 # nontail if
	li %a0 l.6046 #1544
	slli %a0 %a0 2 #1544
	lw %f0 %a0 0 #1544
	jal %zero beq_cont.8695 # then sentence ends
beq_else.8694:
	li %a0 l.5553 #1544
	slli %a0 %a0 2 #1544
	lw %f0 %a0 0 #1544
beq_cont.8695:
	jal %zero beq_cont.8693 # then sentence ends
beq_else.8692:
	bne %a0 0 beq_else.8696 # nontail if
	li %a0 l.5553 #1543
	slli %a0 %a0 2 #1543
	lw %f0 %a0 0 #1543
...
beq_else.8701:
	...
	addi %sp %sp -176 #1570
	lw %ra %sp 172 #1570
	bne %a0 0 beq_else.8704 # nontail if
	lw %f0 %sp 120 #1573
	lw %f1 %sp 144 #1573
	fdiv %f0 %f1 %f0 #1573
...
beq_cont.8705:
	...
	addi %sp %sp -216 #1581
	lw %ra %sp 212 #1581
	bne %a0 0 beq_else.8706 # nontail if
	lw %f0 %sp 160 #1584
	lw %f1 %sp 200 #1584
	fdiv %f0 %f1 %f0 #1584
...
beq_cont.8707:
	...
	addi %sp %sp -256 #1589
	lw %ra %sp 252 #1589
	bne %a0 0 beq_else.8708 # nontail if
	lw %f0 %sp 240 #1588
...
add_light.2562:
	...
	addi %sp %sp -40 #1601
	lw %ra %sp 36 #1601
	bne %a0 0 beq_else.8712 # nontail if
...
trace_reflections.2566:
	...
	addi %sp %sp -72 #1622
	lw %ra %sp 68 #1622
	bne %a0 0 beq_else.8718 # nontail if
...
beq_else.8718:
	...
	lw %ra %sp 76 #1625
	lw %a1 %sp 68 #1623
	bne %a1 %a0 beq_else.8720 # nontail if
	lw %a0 %sp 44 #32
	lw %a1 %a0 0 #32
	lw %a0 %sp 36 #1627
	lw %a13 %sp 40 #1627
	...
	addi %sp %sp -80 #1627
	lw %ra %sp 76 #1627
	bne %a0 0 beq_else.8722 # nontail if
	lw %a0 %sp 64 #1629
...
trace_ray.2571:
	...
	lw %a13 %a13 4 #1643
	sw %a13 %sp 40 #1644
	addi %a13 %zero 4 #1644
	blt 4 %a0 bge_else.8725
	sw %f1 %sp 48 #1645
	sw %a2 %sp 56 #1645
	sw %a13 %sp 60 #1645
	sw %a3 %sp 64 #1645
...
beq_else.8727:
	...
	addi %sp %sp -168 #1665
	lw %ra %sp 164 #1665
	bne %a0 0 beq_else.8734 # nontail if
	addi %a0 %zero 1 #1668
	lw %a1 %sp 108 #1668
	slli %a2 %a1 2 #1668
	lw %a3 %sp 160 #1668
...
beq_cont.8735:
	...
	addi %sp %sp -192 #1683
	lw %ra %sp 188 #1683
	bne %a0 0 beq_else.8736 # nontail if
	lw %a0 %sp 24 #1684
	lw %a1 %sp 104 #1684
	...
	addi %sp %sp -200 #1686
	lw %ra %sp 196 #1686
	jal %zero beq_cont.8737 # then sentence ends
beq_else.8736:
beq_cont.8737:
	lw %a0 %sp 68 #1690
	lw %a13 %sp 12 #1690
	...
	addi %sp %sp -200 #1694
	lw %ra %sp 196 #1694
	bne %a0 0 beq_else.8738
	jalr %zero %ra 0 #1705
beq_else.8738:
	lw %a0 %sp 108 #1644
	blt %a0 4 bge_else.8740 # nontail if
	jal %zero bge_cont.8741 # then sentence ends
bge_else.8740:
	addi %a1 %a0 1 #1697
	addi %a2 %zero 1 #1697
	sub %a2 %zero %a2 #1697
...
beq_else.8745:
	...
	addi %sp %sp -80 #1745
	lw %ra %sp 76 #1745
	bne %a0 0 beq_else.8748 # nontail if
	li %a0 l.5553 #1745
	slli %a0 %a0 2 #1745
	lw %f0 %a0 0 #1745
	jal %zero beq_cont.8749 # then sentence ends
beq_else.8748:
	lw %f0 %sp 64 #555
beq_cont.8749:
	lw %f1 %sp 8 #1746
...
iter_trace_diffuse_rays.2580:
	...
	addi %sp %sp -40 #1757
	lw %ra %sp 36 #1757
	bne %a0 0 beq_else.8752 # nontail if
	lw %a0 %sp 16 #1754
	slli %a1 %a0 2 #1754
	lw %a2 %sp 12 #1754
	add %a14 %a2 %a1 #1754
...
trace_diffuse_ray_80percent.2589:
	...
	sw %a4 %sp 12 #1777
	sw %a0 %sp 16 #1777
	bne %a0 0 beq_else.8755 # nontail if
...
beq_cont.8756:
	lw %a0 %sp 16 #1777
	bne %a0 1 beq_else.8757 # nontail if
...
beq_cont.8758:
	lw %a0 %sp 16 #1777
	bne %a0 2 beq_else.8759 # nontail if
	jal %zero beq_cont.8760 # then sentence ends
beq_else.8759:
	lw %a1 %sp 12 #80
	lw %a2 %a1 8 #80
	lw %a3 %sp 4 #1786
...
beq_cont.8760:
	lw %a0 %sp 16 #1777
	bne %a0 3 beq_else.8761 # nontail if
...
do_without_neighbors.2602:
	...
	add %a14 %a0 %a2 #1666
	lw %a0 %a14 0 #1666
	bne %a0 0 beq_else.8767 # nontail if
...
neighbors_exist.2605:
	...
	lw %a3 %a2 4 #56
	addi %a4 %a1 1 #1854
	blt %a4 %a3 bge_else.8771
	addi %a0 %zero 0 #1862
	jalr %zero %ra 0 #1862
bge_else.8771:
	addi %a3 %zero 0 #1855
	blt 0 %a1 bge_else.8772
	addi %a0 %a3 0 #1855
	jalr %zero %ra 0 #1855
bge_else.8772:
	lw %a1 %a2 0 #56
	addi %a2 %a0 1 #1856
	blt %a2 %a1 bge_else.8773
	addi %a0 %a3 0 #1855
	jalr %zero %ra 0 #1855
bge_else.8773:
	blt 0 %a0 bge_else.8774
	addi %a0 %a3 0 #1855
	jalr %zero %ra 0 #1855
bge_else.8774:
	addi %a0 %zero 1 #1858
...
try_exploit_neighbors.2618:
	...
	addi %sp %sp -48 #1894
	lw %ra %sp 44 #1894
	bne %a0 0 beq_else.8781
	lw %a0 %sp 12 #1906
	lw %a1 %sp 20 #1906
	lw %a13 %sp 16 #1906
	lw %a12 %a13 0 #1906
	jalr %zero %a12 0 #1906
beq_else.8781:
	lw %a0 %sp 12 #1897
	...
	add %a14 %a0 %a1 #1666
	lw %a0 %a14 0 #1666
	bne %a0 0 beq_else.8782 # nontail if
	jal %zero beq_cont.8783 # then sentence ends
beq_else.8782:
	lw %a0 %sp 36 #1899
	lw %a1 %sp 32 #1899
	lw %a2 %sp 28 #1899
...
write_rgb_element.2627:
	...
	blt 255 %a0 bge_else.8786 # nontail if
	addi %a1 %zero 0 #1928
	blt %a0 0 bge_else.8788 # nontail if
	jal %zero bge_cont.8789 # then sentence ends
bge_else.8788:
	addi %a0 %a1 0 #1928
bge_cont.8789:
...
pretrace_diffuse_rays.2631:
	...
	add %a14 %a0 %a2 #1666
	lw %a0 %a14 0 #1666
	bne %a0 0 beq_else.8792 # nontail if
...
pretrace_pixels.2634:
	...
	lw %a10 %a13 8 #1975
	lw %a11 %a13 4 #1975
	addi %a12 %zero 0 #1976
	blt %a1 0 bge_else.8796
	lw %f3 %a7 0 #60
	lw %a7 %a11 0 #58
	sub %a7 %a1 %a7 #1978
	sw %a13 %sp 0 #1978
...
bge_else.8800:
	...
	lw %ra %sp 44 #2021
	addi %a1 %zero 0 #2021
	bne %a0 0 beq_else.8802 # nontail if
	lw %a0 %sp 32 #2018
	slli %a2 %a0 2 #2018
	lw %a3 %sp 20 #2018
	add %a14 %a3 %a2 #2018
...
beq_cont.8803:
	...
	lw %a13 %sp 0 #2029
	lw %a12 %a13 0 #2029
	jalr %zero %a12 0 #2029
scan_line.2651:
	lw %a5 %a13 12 #2034
	lw %a6 %a13 8 #2034
	lw %a7 %a13 4 #2034
	lw %a8 %a7 4 #56
	blt %a0 %a8 bge_else.8804
	jalr %zero %ra 0 #2043
bge_else.8804:
	lw %a7 %a7 4 #56
	addi %a7 %a7 -1 #2038
	...
	sw %a0 %sp 20 #2038
	sw %a5 %sp 24 #2038
	blt %a0 %a7 bge_else.8806 # nontail if
	jal %zero bge_cont.8807 # then sentence ends
bge_else.8806:
	addi %a7 %a0 1 #2039
	add %a2 %a4 %zero
	add %a1 %a7 %zero
...
bge_else.8809:
	...
	lw %a13 %sp 144 #2124
	lw %a12 %a13 0 #2124
	jalr %zero %a12 0 #2124
calc_dirvecs.2679:
	lw %a3 %a13 4 #2128
	addi %a4 %zero 0 #2129
	blt %a0 0 bge_else.8817
	sw %a13 %sp 0 #2131
	sw %a0 %sp 4 #2131
	sw %f0 %sp 8 #2131
	sw %a2 %sp 16 #2131
	...
	lw %a13 %sp 0 #2137
	lw %a12 %a13 0 #2137
	jalr %zero %a12 0 #2137
bge_else.8817:
	jalr %zero %ra 0 #2138
calc_dirvec_rows.2684:
	lw %a3 %a13 4 #2142
	blt %a0 0 bge_else.8819
	sw %a13 %sp 0 #2144
	sw %a0 %sp 4 #2144
	sw %a2 %sp 8 #2144
	sw %a1 %sp 12 #2144
...
create_dirvecs.2693:
	...
	lw %a13 %sp 0 #2170
	lw %a12 %a13 0 #2170
	jalr %zero %a12 0 #2170
bge_else.8823:
	jalr %zero %ra 0 #2171
init_dirvec_constants.2695:
	lw %a2 %a13 4 #2176
	blt %a1 0 bge_else.8825
	slli %a3 %a1 2 #2178
	add %a14 %a0 %a3 #2178
	lw %a3 %a14 0 #2178
	sw %a0 %sp 0 #2178
	...
	lw %a13 %sp 4 #2179
	lw %a12 %a13 0 #2179
	jalr %zero %a12 0 #2179
bge_else.8825:
	jalr %zero %ra 0 #2180
init_vecset_constants.2698:
	lw %a1 %a13 8 #2183
	lw %a2 %a13 4 #2183
	blt %a0 0 bge_else.8827
	slli %a3 %a0 2 #80
	add %a14 %a2 %a3 #80
	lw %a2 %a14 0 #80
...
beq_else.8836:
	...
	addi %sp %sp -24 #2243
	lw %ra %sp 20 #2243
	bne %a0 1 beq_else.8838
	lw %a0 %sp 4 #2246
	lw %a1 %sp 12 #2246
	lw %a13 %sp 8 #2246
	lw %a12 %a13 0 #2246
	jalr %zero %a12 0 #2246
beq_else.8838:
	bne %a0 2 beq_else.8839
	lw %a0 %sp 4 #2248
	lw %a1 %sp 12 #2248
	lw %a13 %sp 0 #2248
	lw %a12 %a13 0 #2248
	jalr %zero %a12 0 #2248
beq_else.8839:
	jalr %zero %ra 0 #2249
beq_else.8835:
	jalr %zero %ra 0 #2251
...
min_caml_start:
	...
	li %a12 read_object.2372 #720
	sw %a12 %a11 0 #720
	sw %a9 %a11 8 #720
	lw %a9 %sp 0 #720
	sw %a9 %a11 4 #720
	addi %a12 %min_caml_hp 0 #729
	addi %min_caml_hp %min_caml_hp 8 #729
	li %a13 read_all_object.2374 #729
	sw %a13 %a12 0 #729
	sw %a11 %a12 4 #729
	addi %a11 %min_caml_hp 0 #753
	addi %min_caml_hp %min_caml_hp 8 #753
	li %a13 read_and_network.2380 #753
	sw %a13 %a11 0 #753
	lw %a13 %sp 28 #753
	sw %a13 %a11 4 #753
	addi %a4 %min_caml_hp 0 #762
	addi %min_caml_hp %min_caml_hp 24 #762
	li %a3 read_parameter.2382 #762
	sw %a3 %a4 0 #762
	sw %a1 %a4 20 #762
	sw %a6 %a4 16 #762
	sw %a11 %a4 12 #762
	...
	lw %a1 %sp 36 #762
	sw %a1 %a4 4 #762
	addi %a3 %min_caml_hp 0 #778
	addi %min_caml_hp %min_caml_hp 8 #778
	li %a6 solver_rect_surface.2384 #778
	sw %a6 %a3 0 #778
	lw %a6 %sp 40 #778
	sw %a6 %a3 4 #778
	addi %a11 %min_caml_hp 0 #793
	addi %min_caml_hp %min_caml_hp 8 #793
	li %a12 solver_rect.2393 #793
	sw %a12 %a11 0 #793
	sw %a3 %a11 4 #793
	addi %a3 %min_caml_hp 0 #802
	addi %min_caml_hp %min_caml_hp 8 #802
	li %a12 solver_surface.2399 #802
	sw %a12 %a3 0 #802
	sw %a6 %a3 4 #802
	addi %a12 %min_caml_hp 0 #850
	addi %min_caml_hp %min_caml_hp 8 #850
	sw %a4 %sp 140 #850
	li %a4 solver_second.2418 #850
	sw %a4 %a12 0 #850
	sw %a6 %a12 4 #850
	addi %a4 %min_caml_hp 0 #879
	addi %min_caml_hp %min_caml_hp 24 #879
	li %a5 solver.2424 #879
	sw %a5 %a4 0 #879
	sw %a3 %a4 16 #879
	sw %a12 %a4 12 #879
	sw %a11 %a4 8 #879
	sw %a10 %a4 4 #879
	addi %a3 %min_caml_hp 0 #896
	addi %min_caml_hp %min_caml_hp 8 #896
	li %a5 solver_rect_fast.2428 #896
	sw %a5 %a3 0 #896
	sw %a6 %a3 4 #896
	addi %a5 %min_caml_hp 0 #929
	addi %min_caml_hp %min_caml_hp 8 #929
	li %a11 solver_surface_fast.2435 #929
	sw %a11 %a5 0 #929
	sw %a6 %a5 4 #929
	addi %a11 %min_caml_hp 0 #938
	addi %min_caml_hp %min_caml_hp 8 #938
	li %a12 solver_second_fast.2441 #938
	sw %a12 %a11 0 #938
	sw %a6 %a11 4 #938
	addi %a12 %min_caml_hp 0 #958
	addi %min_caml_hp %min_caml_hp 24 #958
	li %a2 solver_fast.2447 #958
	sw %a2 %a12 0 #958
	sw %a5 %a12 16 #958
	sw %a11 %a12 12 #958
	sw %a3 %a12 8 #958
	sw %a10 %a12 4 #958
	addi %a2 %min_caml_hp 0 #978
	addi %min_caml_hp %min_caml_hp 8 #978
	li %a5 solver_surface_fast2.2451 #978
	sw %a5 %a2 0 #978
	sw %a6 %a2 4 #978
	addi %a5 %min_caml_hp 0 #986
	addi %min_caml_hp %min_caml_hp 8 #986
	li %a11 solver_second_fast2.2458 #986
	sw %a11 %a5 0 #986
	sw %a6 %a5 4 #986
	addi %a11 %min_caml_hp 0 #1005
	addi %min_caml_hp %min_caml_hp 24 #1005
	li %a8 solver_fast2.2465 #1005
	sw %a8 %a11 0 #1005
	sw %a2 %a11 16 #1005
	sw %a5 %a11 12 #1005
	sw %a3 %a11 8 #1005
	sw %a10 %a11 4 #1005
	addi %a2 %min_caml_hp 0 #1099
	addi %min_caml_hp %min_caml_hp 8 #1099
	li %a3 iter_setup_dirvec_constants.2477 #1099
	sw %a3 %a2 0 #1099
	sw %a10 %a2 4 #1099
	addi %a3 %min_caml_hp 0 #1116
	addi %min_caml_hp %min_caml_hp 16 #1116
	li %a5 setup_dirvec_constants.2480 #1116
	sw %a5 %a3 0 #1116
	sw %a9 %a3 8 #1116
	sw %a2 %a3 4 #1116
	addi %a2 %min_caml_hp 0 #1122
	addi %min_caml_hp %min_caml_hp 8 #1122
	li %a5 setup_startp_constants.2482 #1122
	sw %a5 %a2 0 #1122
	sw %a10 %a2 4 #1122
	addi %a5 %min_caml_hp 0 #1141
	addi %min_caml_hp %min_caml_hp 16 #1141
	li %a8 setup_startp.2485 #1141
	sw %a8 %a5 0 #1141
	lw %a8 %sp 92 #1141
	sw %a8 %a5 12 #1141
	sw %a2 %a5 8 #1141
	sw %a9 %a5 4 #1141
	addi %a2 %min_caml_hp 0 #1189
	addi %min_caml_hp %min_caml_hp 8 #1189
	sw %a3 %sp 144 #1189
	li %a3 check_all_inside.2507 #1189
	sw %a3 %a2 0 #1189
	sw %a10 %a2 4 #1189
	addi %a3 %min_caml_hp 0 #1207
	addi %min_caml_hp %min_caml_hp 32 #1207
	li %a9 shadow_check_and_group.2513 #1207
	sw %a9 %a3 0 #1207
	sw %a12 %a3 28 #1207
	sw %a6 %a3 24 #1207
	sw %a10 %a3 20 #1207
	...
	sw %a2 %a3 4 #1207
	sw %a0 %sp 148 #1237
	addi %a0 %min_caml_hp 0 #1237
	addi %min_caml_hp %min_caml_hp 16 #1237
	sw %a5 %sp 152 #1237
	li %a5 shadow_check_one_or_group.2516 #1237
	sw %a5 %a0 0 #1237
	sw %a3 %a0 8 #1237
	sw %a13 %a0 4 #1237
	addi %a3 %min_caml_hp 0 #1252
	addi %min_caml_hp %min_caml_hp 24 #1252
	li %a5 shadow_check_one_or_matrix.2519 #1252
	sw %a5 %a3 0 #1252
	sw %a12 %a3 20 #1252
	sw %a6 %a3 16 #1252
	sw %a0 %a3 12 #1252
	sw %a9 %a3 8 #1252
	sw %a7 %a3 4 #1252
	addi %a0 %min_caml_hp 0 #1286
	addi %min_caml_hp %min_caml_hp 40 #1286
	li %a5 solve_each_element.2522 #1286
	sw %a5 %a0 0 #1286
	lw %a5 %sp 48 #1286
	sw %a5 %a0 36 #1286
	lw %a12 %sp 88 #1286
	...
	sw %a2 %a0 4 #1286
	sw %a2 %sp 160 #1327
	addi %a2 %min_caml_hp 0 #1327
	addi %min_caml_hp %min_caml_hp 16 #1327
	li %a3 solve_one_or_network.2526 #1327
	sw %a3 %a2 0 #1327
	sw %a0 %a2 8 #1327
	sw %a13 %a2 4 #1327
	addi %a0 %min_caml_hp 0 #1336
	addi %min_caml_hp %min_caml_hp 24 #1336
	li %a3 trace_or_matrix.2530 #1336
	sw %a3 %a0 0 #1336
	sw %a5 %a0 20 #1336
	sw %a12 %a0 16 #1336
	sw %a6 %a0 12 #1336
	sw %a4 %a0 8 #1336
	sw %a2 %a0 4 #1336
	addi %a2 %min_caml_hp 0 #1363
	addi %min_caml_hp %min_caml_hp 16 #1363
	li %a3 judge_intersection.2534 #1363
	sw %a3 %a2 0 #1363
	sw %a0 %a2 12 #1363
	sw %a5 %a2 8 #1363
	sw %a1 %a2 4 #1363
	addi %a0 %min_caml_hp 0 #1376
	addi %min_caml_hp %min_caml_hp 40 #1376
	li %a3 solve_each_element_fast.2536 #1376
	sw %a3 %a0 0 #1376
	sw %a5 %a0 36 #1376
	sw %a8 %a0 32 #1376
	sw %a11 %a0 28 #1376
	...
	lw %a4 %sp 160 #1376
	sw %a4 %a0 4 #1376
	addi %a4 %min_caml_hp 0 #1417
	addi %min_caml_hp %min_caml_hp 16 #1417
	li %a8 solve_one_or_network_fast.2540 #1417
	sw %a8 %a4 0 #1417
	sw %a0 %a4 8 #1417
	sw %a13 %a4 4 #1417
	addi %a0 %min_caml_hp 0 #1427
	addi %min_caml_hp %min_caml_hp 24 #1427
	li %a8 trace_or_matrix_fast.2544 #1427
	sw %a8 %a0 0 #1427
	sw %a5 %a0 16 #1427
	sw %a11 %a0 12 #1427
	sw %a6 %a0 8 #1427
	sw %a4 %a0 4 #1427
	addi %a4 %min_caml_hp 0 #1451
	addi %min_caml_hp %min_caml_hp 16 #1451
	li %a6 judge_intersection_fast.2548 #1451
	sw %a6 %a4 0 #1451
	sw %a0 %a4 12 #1451
	sw %a5 %a4 8 #1451
	sw %a1 %a4 4 #1451
	addi %a0 %min_caml_hp 0 #1470
	addi %min_caml_hp %min_caml_hp 16 #1470
	li %a6 get_nvector_rect.2550 #1470
	sw %a6 %a0 0 #1470
	lw %a6 %sp 60 #1470
	sw %a6 %a0 8 #1470
	sw %a9 %a0 4 #1470
	addi %a8 %min_caml_hp 0 #1478
	addi %min_caml_hp %min_caml_hp 8 #1478
	li %a11 get_nvector_plane.2552 #1478
	sw %a11 %a8 0 #1478
	sw %a6 %a8 4 #1478
	addi %a11 %min_caml_hp 0 #1486
	addi %min_caml_hp %min_caml_hp 16 #1486
	li %a13 get_nvector_second.2554 #1486
	sw %a13 %a11 0 #1486
	sw %a6 %a11 8 #1486
	sw %a7 %a11 4 #1486
	addi %a13 %min_caml_hp 0 #1508
	...
	sw %a0 %a13 8 #1508
	sw %a8 %a13 4 #1508
	addi %a0 %min_caml_hp 0 #1522
	addi %min_caml_hp %min_caml_hp 8 #1522
	li %a7 utexture.2559 #1522
	sw %a7 %a0 0 #1522
	lw %a7 %sp 64 #1522
	sw %a7 %a0 4 #1522
	addi %a8 %min_caml_hp 0 #1598
	addi %min_caml_hp %min_caml_hp 16 #1598
	li %a11 add_light.2562 #1598
	sw %a11 %a8 0 #1598
	sw %a7 %a8 8 #1598
	lw %a11 %sp 72 #1598
	sw %a11 %a8 4 #1598
	sw %a13 %sp 164 #1615
	addi %a13 %min_caml_hp 0 #1615
	addi %min_caml_hp %min_caml_hp 40 #1615
	sw %a2 %sp 168 #1615
	li %a2 trace_reflections.2566 #1615
	sw %a2 %a13 0 #1615
	lw %a2 %sp 156 #1615
	sw %a2 %a13 32 #1615
	lw %a10 %sp 136 #1615
	...
	sw %a11 %a10 8 #1643
	sw %a8 %a10 4 #1643
	addi %a8 %min_caml_hp 0 #1734
	addi %min_caml_hp %min_caml_hp 56 #1734
	li %a11 trace_diffuse_ray.2577 #1734
	sw %a11 %a8 0 #1734
	sw %a0 %a8 48 #1734
	sw %a7 %a8 44 #1734
	sw %a2 %a8 40 #1734
	...
	li %a6 calc_diffuse_using_1point.2593 #1800
	sw %a6 %a4 0 #1800
	sw %a1 %a4 12 #1800
	lw %a1 %sp 72 #1800
	sw %a1 %a4 8 #1800
	sw %a0 %a4 4 #1800
	addi %a6 %min_caml_hp 0 #1818
	addi %min_caml_hp %min_caml_hp 16 #1818
	li %a7 calc_diffuse_using_5points.2596 #1818
	sw %a7 %a6 0 #1818
	sw %a1 %a6 8 #1818
	sw %a0 %a6 4 #1818
	addi %a7 %min_caml_hp 0 #1838
	addi %min_caml_hp %min_caml_hp 8 #1838
	li %a8 do_without_neighbors.2602 #1838
	sw %a8 %a7 0 #1838
	sw %a4 %a7 4 #1838
	addi %a4 %min_caml_hp 0 #1853
	addi %min_caml_hp %min_caml_hp 8 #1853
	li %a8 neighbors_exist.2605 #1853
	sw %a8 %a4 0 #1853
	lw %a8 %sp 76 #1853
	sw %a8 %a4 4 #1853
	addi %a9 %min_caml_hp 0 #1887
	addi %min_caml_hp %min_caml_hp 16 #1887
	li %a11 try_exploit_neighbors.2618 #1887
	sw %a11 %a9 0 #1887
	sw %a7 %a9 8 #1887
	sw %a6 %a9 4 #1887
	addi %a6 %min_caml_hp 0 #1912
	addi %min_caml_hp %min_caml_hp 8 #1912
	li %a11 write_ppm_header.2625 #1912
	sw %a11 %a6 0 #1912
	sw %a8 %a6 4 #1912
	addi %a11 %min_caml_hp 0 #1932
	addi %min_caml_hp %min_caml_hp 8 #1932
	li %a12 write_rgb.2629 #1932
	sw %a12 %a11 0 #1932
	sw %a1 %a11 4 #1932
	addi %a12 %min_caml_hp 0 #1946
	addi %min_caml_hp %min_caml_hp 16 #1946
	sw %a6 %sp 176 #1946
	li %a6 pretrace_diffuse_rays.2631 #1946
	sw %a6 %a12 0 #1946
	sw %a2 %a12 12 #1946
	sw %a3 %a12 8 #1946
	sw %a0 %a12 4 #1946
	...
	li %a12 pretrace_line.2641 #2000
	sw %a12 %a10 0 #2000
	lw %a12 %sp 104 #2000
	sw %a12 %a10 24 #2000
	lw %a12 %sp 100 #2000
	...
	li %a7 calc_dirvec.2671 #2107
	sw %a7 %a4 0 #2107
	sw %a3 %a4 4 #2107
	addi %a7 %min_caml_hp 0 #2128
	...
	li %a12 create_dirvecs.2693 #2166
	sw %a12 %a11 0 #2166
	sw %a3 %a11 12 #2166
	sw %a9 %a11 8 #2166
	sw %a7 %a11 4 #2166
	addi %a9 %min_caml_hp 0 #2176
	addi %min_caml_hp %min_caml_hp 8 #2176
	li %a12 init_dirvec_constants.2695 #2176
	sw %a12 %a9 0 #2176
	lw %a12 %sp 144 #2176
	sw %a12 %a9 4 #2176
	sw %a0 %sp 180 #2183
	...
	li %a6 init_vecset_constants.2698 #2183
	sw %a6 %a0 0 #2183
	sw %a9 %a0 8 #2183
	sw %a3 %a0 4 #2183
	addi %a3 %min_caml_hp 0 #2190
	addi %min_caml_hp %min_caml_hp 16 #2190
	li %a6 init_dirvecs.2700 #2190
	sw %a6 %a3 0 #2190
	sw %a0 %a3 12 #2190
	sw %a11 %a3 8 #2190
	sw %a4 %a3 4 #2190
	...
	li %a6 setup_rect_reflection.2709 #2208
	sw %a6 %a4 0 #2208
	lw %a6 %sp 148 #2208
	sw %a6 %a4 12 #2208
	sw %a13 %a4 8 #2208
	...
	li %a6 setup_reflections.2715 #2238
	sw %a6 %a0 0 #2238
	sw %a7 %a0 12 #2238
	sw %a4 %a0 8 #2238
	sw %a5 %a0 4 #2238
